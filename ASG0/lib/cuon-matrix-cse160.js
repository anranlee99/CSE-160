 ...
 */
/**
 * @typedef {Object} Vector3 - A 3D vector
 * @property {number[]} elements - The elements of the vector
 * @property {function} set - Copy vector
 * @property {function} add - Add other to this vector
 * @property {function} sub - Subtract other from this vector
 * @property {function} div - Divide this vector by a scalar
 * @property {function} mul - Multiply this vector by a scalar
 * @property {function} magnitude - Calculate the magnitude (or length) of this vector
 * @property {function} normalize - Normalize this vector
 * 
 */
class Vector3 {
  constructor(opt_src) {
  ...
  /**
   * Copy vector.
   * @param {Vector3} src source vector
   * @returns {Vector3}
   * 
   */
  set(src) {
  ...
  static cross(other1, other2) {
    // Insert your code here.
        ...
        const v3 = new Vector3(); // Modify this line to calculate cross product between other1 and other2.
        // a x b = s = <a2b3 - a3b2, a3b1 - a1b3, a1b2 - a2b1>
...
class Matrix4 {
   ...
   * @param {number} normX, @param {number} normY, @param {number} normZ The normal vector of the plane.(Not necessary to be normalized.)
   * @param {number} planeX, @param {number} planeY, @param {number} planeZ The coordinate of arbitrary points on a plane.
   * @param {number} lightX, @param {number} lightY, @param {number} lightZ The vector of the direction of light.(Not necessary to be normalized.)
   * @return this
   */
